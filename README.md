# Volatility Analysis: Stocks vs Tech vs Crypto (2014â€“2024)
...
**Key question:** Is cryptocurrency's extra volatility actually compensated by extra return â€” and does adding it to a stock portfolio provide real diversification benefit?

## Key Findings

- **Crypto is 5â€“6x more volatile than equities.** Bitcoin's average annualized volatility (71.4%) is roughly 4.9x the S&P 500's (14.6%); Ethereum's (88.7%) is roughly 6.1x higher.
- **Higher volatility doesn't always mean better returns.** Bitcoin's risk was well compensated (Sharpe ratio 0.13, the best of the four assets), but Ethereum's was not (Sharpe ratio 0.09, the worst) â€” despite both being "crypto."
- **Stockâ€“crypto correlation is moderate (0.35â€“0.42),** compared to 0.93 between the two equity indices â€” suggesting a real, if bounded, diversification benefit.
...
- **Data:** Monthly historical price data from Yahoo Finance, January 2014 â€“ December 2024 (Ethereum data begins November 2017).
- **Volatility:** Rolling 252-day standard deviation of returns, annualized.
- **Correlation:** Pearson correlation coefficient on monthly returns over the common analysis period (Nov 2017 â€“ Dec 2024).
- **Sharpe ratio:** Annualized return Ã· annualized volatility (0% risk-free rate assumed).
...
```
â”œâ”€â”€ README.md
â”œâ”€â”€ REPORT.md              # Full written case study
â”œâ”€â”€ scripts/                # R scripts for each chart
â”œâ”€â”€ charts/                  # Output PNGs (300 DPI)
â””â”€â”€ data/                    # Raw CSV price data
```
